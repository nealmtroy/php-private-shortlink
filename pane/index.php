...
<head>
    ...
    <style>
        @import url("https://fonts.googleapis.com/css?family=Acme|Anton|Cabin+Sketch|Covered+By+Your+Grace|Homemade+Apple|Lalezar|Lato:100,300,300i,700,900|Raleway:200,300,300i,400,600,700|Special+Elite|VT323");
        ...
        margin-right: auto;
        overflow: hidden;
        box-shadow: -4px 12px 0px -6px rgba(0, 0, 0, 0.1);
        }
        ...
        -o-animation: color_change 1s infinite alternate,
            opacity 1s infinite alternate;
        animation: color_change 0.1s infinite alternate, opacity 1s infinite alternate;
    ...
    <style>
        ...
        input[type="password"]:focus {
            outline: none;
            border: solid #bc5454 2px;
            box-shadow: 1px 0px 4px 4px rgb(243 0 0 / 10%)
        }
    </style>
</head>
<body>
